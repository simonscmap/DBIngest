...
########### OPTS ###########
server = 'Rainier'
tableName = 'tblKM1906_Gradients3'
rawFilePath = cfgv.rep_gradients_3_raw
rawFileName = 'gradients_3_core_uway.xlsx'
usecols=['Time',
'Latitude',
'Longitude',
'Depth',
...
def maketblKM1906_Gradients3(rawFilePath, rawFileName, tableName):
...
export_path = maketblKM1906_Gradients3(rawFilePath, rawFileName, tableName)
