...
server = 'Rainier'
tableName = 'tblBATS_Pigment_Validation'
rawFilePath = cfgv.rep_bats_raw + 'Pigments/'
rawFileName = 'bval_pigments.txt'
# ############################
# ############################

def makeBATS_Pigment_Validation(rawFilePath, rawFileName, tableName):
...
df = makeBATS_Pigment_Validation(rawFilePath, rawFileName, tableName)
# export_path = makeBATS_Pigment_Validation(rawFilePath, rawFileName, tableName)
