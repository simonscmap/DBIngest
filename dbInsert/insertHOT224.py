...
########### OPTS ###########
server = 'Rainier'
tableName = 'tblHOT_224'
rawFilePath = cfgv.rep_HOT_224_raw
rawFileName = 'HOT_224.xlsx'
usecols=['Time',
'Latitude',
'Longitude',
'Depth',
...
def makeHOT_224(rawFilePath, rawFileName, tableName):
...
export_path = makeHOT_224(rawFilePath, rawFileName, tableName)
