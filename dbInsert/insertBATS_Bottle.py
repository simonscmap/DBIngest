...
rawFileName = 'bats_bottle.txt'

# ############################
# ############################

def makeBATS_Bottle(rawFilePath, rawFileName, tableName):
...
# df = makeBATS_Bottle(rawFilePath, rawFileName, tableName)
export_path = makeBATS_Bottle(rawFilePath, rawFileName, tableName)
