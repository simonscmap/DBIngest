...
"""KOK1606_Gradients1_TargetedMetabolites data Catalog Table"""
server = 'Rainier'
...
""" Strings """
DB='Opedia'
Dataset_Name = 'tblKOK1606_Gradients1_TargetedMetabolites'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(115,589)',server)
