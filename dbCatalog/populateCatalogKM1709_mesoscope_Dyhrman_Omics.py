...
"""KM1709_mesoscope_Dyhrman_Omics data Catalog Table"""
server = 'Rainier'
...
""" Strings """
DB='Opedia'
Dataset_Name = 'tblKM1709_mesoscope_Dyhrman_Omics'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(124,595)',server)
