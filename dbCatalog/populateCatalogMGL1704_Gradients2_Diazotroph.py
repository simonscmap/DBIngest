...
"""MGL1704_Gradients2_Diazotroph data Catalog Table"""
server = 'Rainier'
tableName = 'tblMGL1704_Gradients2_Diazotroph'
rawFilePath = cfgv.rep_gradients_2_raw
rawFileName = 'MGL1704_Gradients2_Diazotroph_data.xlsx'
...
Study_Domain_ID_list = ['3'] * len(vars_metadata) # Biology
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(127,593)',server)
