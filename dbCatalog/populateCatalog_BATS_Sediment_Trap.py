...
rawFilePath = cfgv.doc_bats_raw
rawFileName = 'BATS_Sediment_Trap.xlsx'
server = 'Rainier'
...
Distributor = 'Bermuda Institute of Ocean Sciences'
...
Sensor_ID_list = ['','','','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12','12',''] #CTDX2, BottleX6, nullx1
Process_ID_list = ['2'] * len(vars_metadata) # Reprocessed
Study_Domain_ID_list =  ['4'] * len(vars_metadata) # Biogeochemistry
