...
rawFilePath = cfgv.doc_oceans_melting_greenland_CTD_raw
rawFileName = 'Oceans_Melting_Greenland_CTD_metadata.xlsx'
server = 'Rainier'
...
Sensor_ID_list = ['5'] * len(vars_metadata) # CTD
