...
"""MGL1704_Gradients2_TargetedMetabolites data Catalog Table"""
server = 'Rainier'
tableName = 'tblMGL1704_Gradients2_TargetedMetabolites'
rawFilePath = cfgv.rep_gradients_2_raw
rawFileName = 'MGL1706_Gradients2_TargetedMetabolites.xlsx'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(148,593)',server)
