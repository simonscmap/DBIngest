...
rawFilePath = cfgv.doc_NOAA_NSIDC_CDR_SeaIce_raw
rawFileName = 'NOAA_NSIDC_CDR.xlsx'
server = 'Rainier'
...
Distributor = 'National Snow and Ice Data Center'
...
spatial_res_list = ['10'] * len(vars_metadata) # 25kmx25km
temporal_res_list = ['3'] * len(vars_metadata) # daily
