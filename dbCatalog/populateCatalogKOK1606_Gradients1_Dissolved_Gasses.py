...
"""KOK1606_Gradients1_Dissolved_Gasses data Catalog Table"""
server = 'Rainier'
...
Distributor = 'Dave Karl Lab - University of Hawaii - Manoa'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(151,589)',server)
