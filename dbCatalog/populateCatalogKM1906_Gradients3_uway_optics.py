...
"""KM1906_Gradients3_uway_optics data Catalog Table"""
server = 'Rainier'
...
""" Strings """
DB='Opedia'
Dataset_Name = 'tblKM1906_Gradients3_uway_optics'
...
Study_Domain_ID_list = ['1','1','1','1','3','1','3','1','1']
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(130,614)',server)
