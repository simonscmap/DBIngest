...
"""km1314 cobalamin data Catalog Table"""
server = 'Rainier'
tableName = 'tblKM1314_Cobalmins'
rawFilePath = cfgv.rep_KM1314_cobalamin_raw
rawFileName = 'Heal2017_CobalaminData.xlsx'
...
Distributor = 'Ingalls Lab - University of Washington'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(146,593)',server)
