...
"""KOK1606_Gradients1_uway_optics data Catalog Table"""
server = 'Rainier'
...
""" Strings """
DB='Opedia'
Dataset_Name = 'tblKOK1606_Gradients1_uway_optics'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(129,589)',server)
