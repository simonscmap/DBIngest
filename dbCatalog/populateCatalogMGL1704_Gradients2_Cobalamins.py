...
"""MGL1704_Gradients2_Cobalamins data Catalog Table"""
server = 'Rainier'
...
""" Strings """
DB='Opedia'
Dataset_Name = 'tblMGL1704_Gradients2_Cobalamins'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(112,593)',server)
