...
"""KM1906_Gradients3_uw_tsg data Catalog Table"""
server = 'Rainier'
tableName = 'tblKM1906_Gradients3_uw_tsg'
rawFilePath = cfgv.rep_gradients_3_raw
rawFileName = 'gradients3_uw_tsg_metadata.xlsx'
...
""" Strings """
DB='Opedia'
Dataset_Name = 'tblKM1906_Gradients3_uw_tsg'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(125,614)',server)
