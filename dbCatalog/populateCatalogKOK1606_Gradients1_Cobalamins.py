...
"""KOK1606_Gradients1_Cobalamins data Catalog Table"""
server = 'Rainier'
...
""" Strings """
DB='Opedia'
Dataset_Name = 'tblKOK1606_Gradients1_Cobalamins'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(111,589)',server)
