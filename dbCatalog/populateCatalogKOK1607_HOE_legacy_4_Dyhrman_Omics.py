...
"""KOK1607_HOE_legacy_4_Dyhrman_Omics data Catalog Table"""
server = 'Rainier'
tableName = 'tblKOK1607_HOE_legacy_4_Dyhrman_Omics'
rawFilePath = cfgv.rep_HOE_legacy_4_raw
rawFileName = 'Dyhrman__HL4_complete.xlsx'
...
Study_Domain_ID_list = ['','','11','11','11','3','3','3','11','11','11']
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(123,590)',server)
