...
"""KOK1806_HOT_LAVA_Dyhrman_Omics data Catalog Table"""
server = 'Rainier'
...
""" Strings """
DB='Opedia'
Dataset_Name = 'tblKOK1806_HOT_LAVA_Dyhrman_Omics'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(121,607)',server)
