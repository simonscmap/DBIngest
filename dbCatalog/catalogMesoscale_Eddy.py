...
"""Mesoscale_Eddy data Catalog Table"""
tableName = 'tblMesoscale_Eddy'
rawFilePath = cfgv.rep_Mesoscale_Eddy_raw
rawFileName = 'Mesoscale_Eddymetadata.xlsx'
############################
...
Distributor = 'NOAA - https://www.nodc.noaa.gov/ocads/oceans/Mesoscale_Eddy/GlopDV.html'
