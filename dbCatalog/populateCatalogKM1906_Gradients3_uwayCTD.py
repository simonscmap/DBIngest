...
"""KM1906_Gradients3_uwayCTD data Catalog Table"""
server = 'Rainier'
tableName = 'tblKM1906_Gradients3_uwayCTD'
rawFilePath = cfgv.rep_gradients_3_raw
rawFileName = 'tblKM1906_Gradients3_uwayCTD.xlsx'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(120,614)',server)
