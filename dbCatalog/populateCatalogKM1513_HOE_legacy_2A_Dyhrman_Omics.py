...
"""KM1513_HOE_legacy_2A_Dyhrman_Omics data Catalog Table"""
server = 'Rainier'
...
""" Strings """
DB='Opedia'
Dataset_Name = 'tblKM1513_HOE_legacy_2A_Dyhrman_Omics'
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(122,581)',server)
