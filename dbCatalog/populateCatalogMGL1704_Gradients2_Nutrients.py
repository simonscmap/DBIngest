...
"""MGL1704_Gradients2_Nutrients data Catalog Table"""
server = 'Rainier'
...
Study_Domain_ID_list = ['','','','4','4','4','4','4','4','4','4','4'] * len(vars_metadata)
...
# cF.lineInsert('tblDataset_Cruises', '(Dataset_ID, Cruise_ID)', '(149,593)',server)
